% The earlier submission on 25th can be found here https://csciitd-my.sharepoint.com/:f:/g/personal/cs1210095_iitd_ac_in/Eusp9ZN1RzlMlQ3FXw6wuFMBUpXCHszpo6eTtQ1Ux9Ip4A?e=StOK7Y
...
hastype(G, div(E1, E2), intT) :- hastype(G, E1, intT), hastype(G, E2, intT), \+ zero(E2). % eval not implemented
